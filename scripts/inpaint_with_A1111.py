...
parser.add_argument('--partial_textures', type=str, help='Input folder with partial textures', default="./dummy_data/uv-textures")
parser.add_argument('--masks', type=str, help='Input folder with UV masks (i.e. pixels to inpaint)', default="./dummy_data/uv-textures-masks")
parser.add_argument('--inpainted_textures', type=str, help='Output folder for inpainted textures', default="./dummy_data/uv-textures-inpainted")
